...
<br><br><br>
        ...
        <div class="container" style="margin-top: 5%;">
            ...
            <br><br><br>   
            <label><b>Cadastro de Funcionario</b></label>
              ...
              <div class="form-group">
                ...
                <input name="telefone1" type="text" class="form-control" id="exampleFormControlInput1" placeholder="(yy) yyyyy-yyyy">
              </div>

              <div class="form-group">
                <label><b>Telefone2:</b></label>
                <input name="telefone2" type="text" class="form-control" id="exampleFormControlInput1" placeholder="(yy) yyyyy-yyyy">
              </div>

              <div class="form-group">
                <label><b>Data Nascimento:</b></label>
                <input  name="data_nasc" type="date" class="form-control" id="exampleFormControlInput1" placeholder="DD/MM/AAAA" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input name="numero" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Digite..." required>
              </div>

              <div class="form-group">
                <label><b>Data Contrato:</b></label>
                <input  name="data_contraro" type="date" class="form-control" id="exampleFormControlInput1" placeholder="DD/MM/AAAA" required>
              </div>

              <div class="form-group">
                <label><b>Cargo:</b></label>
                <input name="cargo" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Digite..." required>
              </div>

              <div class="form-group">
                <label><b>Salario:</b></label>
                <input name="salario" type="text" class="form-control" id="exampleFormControlInput1" placeholder="000.00" required>
              </div>
