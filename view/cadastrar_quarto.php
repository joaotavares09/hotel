...
<br><br><br>
        ...
        <div class="container" style="margin-top: 5%;">
            ...
            <form method="post" action="../controller/cadastrarQuarto.php">
            <br><br><br>   
            <label><b>Cadastro de Quarto</b></label>
              ...
              <div class="form-group">  
                <div class="checkbox">
                    ...
                    <label>
                        <input type="radio"  name='status' value="Livre" checked> Livre 
              ...
              <div class="form-group">
                ...
                <input name="descricao" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Descrição...">
              </div>

              <!-- <div class="form-group">
                <label><b>Salário:</b></label>
                <input  name="salario" type="text" class="form-control" id="exampleFormControlInput1" placeholder="zzz.zz" required>
              </div> --> 
