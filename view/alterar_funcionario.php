...
<form method="post" action="../controller/alterarFuncionario.php">
  <br>   
  <label><b>Alterar dados do Funcionario</b></label><br>
  <div class="form-group">
    <input name="id_funcionario" type="hidden"  value="<?php echo $_GET['id'] ?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">  
    ...
    <div class="form-group">
      ...
      <input  name="data_contrato" class="form-control" type="date" id="exampleFormControlInput1"  value="<?php echo $_GET['data_contrato']?>" required>
    </div>

    <div class="form-group">
      <label><b>Cargo:</b></label>
      <input name="cargo" type="text" class="form-control" id="textNome"  
      value="<?php echo $_GET['cargo']?>" required>
    </div>

    <div class="form-group">
      <label><b>Salario:</b></label>
      <input name="salario" type="text" class="form-control" id="textNome"  
      value="<?php echo $_GET['salario']?>" required>
    </div>
